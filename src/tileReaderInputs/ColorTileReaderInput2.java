...
public class ColorTileReaderInput2 extends TileReaderInput {
	 ...
	 * @param settings_
	 */
	public ColorTileReaderInput2(ImagePlus croppedImage, ImagePlus thresholdedImage, Roi roi, ColorSettings settings_, Point colonyCenter_){
		croppedImage.setRoi(roi);
		croppedImage.copy(false);
		this.tileImage = ImagePlus.getClipboard();
		ImagePlus.resetClipboard();
		...
		this.colonyCenter = new Point(colonyCenter_);
	}
	 ...
	 * @param settings_
	 */
	public ColorTileReaderInput2(ImagePlus tileImage_, ImagePlus thresholdedTileImage_, ColorSettings settings_, Point colonyCenter_){
		tileImage = tileImage_;
		thresholdedTileImage = thresholdedTileImage_;
		settings = settings_;
		this.colonyCenter = new Point(colonyCenter_);
