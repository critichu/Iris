 ...
 *
 */
public class BsubtilisHazyProfileHSB extends Profile {
	 ...
	 */
	public static String profileNotes = "This profile is calibrated for use in measuring the colony sizes and opacities of B.subtilis on the UCSF screens. " +
			"This version uses the HSB brightness conversion " +
			"plus a correction to detect hazy colonies (which B. subtilis typically makes).";
	...
	public void analyzePicture(String filename){
		...
		output.append("Iris version: " + IrisGUI.IrisVersion + ", build id: " + IrisGUI.IrisBuild + "\n");
