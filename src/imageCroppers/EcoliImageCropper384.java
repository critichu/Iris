 ...
 *This specific image cropper has been customized to work with the E.coli screen 384 plates.
 *
 */
public class EcoliImageCropper384 {
	...
	private static Roi findPlateBorders(ImagePlus originalImage) {
		...
		int columnsStartArea = width/2 - 300;
		int columnsEndArea = width/2 + 300;
		...
		//define from where to where to get the sums of brightness (in the sawtooth pattern)
		int rowsStartArea = height/2 - 200;
		int rowsEndArea = height/2 + 200;
		//get the sublist of those sums
		...
		int offsetFromPlateLeftRight = 90;
		int offsetFromPlateTopBottom = 10;
					
		int indexOfLeftColoniesStart = indexOfLeftBorder + offsetFromPlateLeftRight;
		int indexOfRightColoniesStart = indexOfRightBorder - offsetFromPlateLeftRight;
		int indexOfTopColoniesStart = indexOfTopBorder + offsetFromPlateTopBottom;
		int indexOfBottomColoniesStart = indexOfBottomBorder - offsetFromPlateTopBottom;
