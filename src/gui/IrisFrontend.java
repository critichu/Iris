...
public class IrisFrontend {
	 ...
	 */
	public static String IrisVersion = "0.9.5.12";

	/**
	 * This string holds the hash id of Iris versioning in Git
	 */
	public static String IrisBuild = "15d635b";
